...
<meta charset="utf-8">
	...
	<title>LIS4381 - P2: Edit Petstore</title>
						...
						<form id="edit_petstore" method="post" class="form-horizontal" action="edit_petstore_process.php">
							...
							<?php
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="tel" class="form-control" maxlength="10" name="pst_phone" value="<?php echo $result['pst_phone']; ?>"/>
										</div>
								</div>
								<div class="form-group">
										<label class="col-sm-3 control-label">Email:</label>
										<div class="col-sm-5">
												<input type="email" class="form-control" maxlength="100" name="pst_email" value="<?php echo $result['pst_email']; ?>"/>
										</div>
								</div>
								<div class="form-group">
										<label class="col-sm-3 control-label">URL:</label>
										<div class="col-sm-5">
												<input type="url" class="form-control" maxlength="100" name="pst_url" value="<?php echo $result['pst_url']; ?>"/>
										</div>
								</div>
								<div class="form-group">
							...
							?>
								...
								<div class="form-group">
										<div class="col-sm-12">
												<button type="submit" class="btn btn-primary center-block" name="edit" value="edit">Update</button>
										</div>
								</div>
						</form>
					</div>
